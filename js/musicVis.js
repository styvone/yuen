...
function scaleColor(value) {
	wave.material.color.set(value);
}
function shadeColor(p, from, to) {
...
function audioUpdate() {
	var colorVal = scaleBetween(getVolume(), 0, 1, 0, 255);
	colorVal = ((-1)*colorVal)+1;
	var x = shadeColor(colorVal, "#F00");
